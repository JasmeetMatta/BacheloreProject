...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a100csg324-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
read_checkpoint -cell [get_cells design_1_i/Led_AXI_0/U0/Led_AXI_v1_0_S_AXI_inst/count_0] ./netlists/CountUp/LedCount.dcp
opt_design
place_design
route_design

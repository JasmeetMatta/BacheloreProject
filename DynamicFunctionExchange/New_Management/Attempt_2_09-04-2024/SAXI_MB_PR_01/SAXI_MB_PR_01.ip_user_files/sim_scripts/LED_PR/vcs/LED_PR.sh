...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../SAXI_MB_PR_01.gen/sources_1/bd/LED_PR/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../SAXI_MB_PR_01.gen/sources_1/bd/LED_PR/ipshared/30ef" +incdir+"../../../../SAXI_MB_PR_01.gen/sources_1/bd/LED_PR/ipshared/ec67/hdl" +incdir+"../../../../SAXI_MB_PR_01.gen/sources_1/bd/LED_PR/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.LED_PR xil_defaultlib.glbl -o LED_PR_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./LED_PR_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key LED_PR_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc LED_PR_simv.daidir vcs_lib c.obj)

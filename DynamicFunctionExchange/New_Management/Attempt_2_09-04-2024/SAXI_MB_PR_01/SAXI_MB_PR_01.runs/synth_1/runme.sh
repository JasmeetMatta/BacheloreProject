...
HD_PWD='C:/VProject/Attempt_2_09-04-2024/SAXI_MB_PR_01/SAXI_MB_PR_01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_PR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_PR_wrapper.tcl

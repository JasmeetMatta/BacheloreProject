...
HD_PWD='C:/VProject/Attempt_2_09-04-2024/SAXI_MB_PR_01/SAXI_MB_PR_01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_PR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_PR_wrapper.tcl -notrace

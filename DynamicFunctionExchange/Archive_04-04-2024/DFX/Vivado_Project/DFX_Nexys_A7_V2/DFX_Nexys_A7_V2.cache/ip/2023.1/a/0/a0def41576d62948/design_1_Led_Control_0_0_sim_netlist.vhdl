...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Led_Control is
  ...
  signal SecondClock_reg : STD_LOGIC_VECTOR ( 19 downto 0 );
  ...
  signal \NLW_SecondClock_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\SecondClock[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
      I0 => SecondClock_reg(15),
      I1 => SecondClock_reg(12),
      I2 => SecondClock_reg(19),
      I3 => SecondClock_reg(11),
      O => \SecondClock[0]_i_3_n_0\
    );
\SecondClock[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
      I0 => SecondClock_reg(7),
      I1 => SecondClock_reg(13),
      I2 => SecondClock_reg(9),
      I3 => SecondClock_reg(8),
      O => \SecondClock[0]_i_4_n_0\
    );
\SecondClock[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
      I0 => SecondClock_reg(18),
      I1 => SecondClock_reg(10),
      I2 => SecondClock_reg(16),
      I3 => SecondClock_reg(1),
      O => \SecondClock[0]_i_5_n_0\
    );
\SecondClock[0]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
      I0 => SecondClock_reg(4),
      I1 => SecondClock_reg(14),
      I2 => SecondClock_reg(6),
      I3 => SecondClock_reg(0),
      O => \SecondClock[0]_i_6_n_0\
    );
\SecondClock[0]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
      I0 => SecondClock_reg(5),
      I1 => SecondClock_reg(3),
      I2 => SecondClock_reg(17),
      I3 => SecondClock_reg(2),
...
\SecondClock_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_SecondClock_reg[16]_i_1_CO_UNCONNECTED\(3),

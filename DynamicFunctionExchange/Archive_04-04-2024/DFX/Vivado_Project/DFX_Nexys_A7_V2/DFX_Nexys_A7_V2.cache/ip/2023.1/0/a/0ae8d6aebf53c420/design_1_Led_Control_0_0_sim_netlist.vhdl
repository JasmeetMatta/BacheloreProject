...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Led_Control is
  ...
  signal SecondClock_reg : STD_LOGIC_VECTOR ( 13 downto 0 );
  ...
  signal \NLW_SecondClock_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_SecondClock_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
Sclock_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EF10"
    )
        port map (
...
\SecondClock[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"10FF"
    )
        port map (
...
\SecondClock[0]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\SecondClock_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_SecondClock_reg[12]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \SecondClock_reg[12]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_SecondClock_reg[12]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \SecondClock_reg[12]_i_1_n_6\,
      O(0) => \SecondClock_reg[12]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => SecondClock_reg(13 downto 12)
    );

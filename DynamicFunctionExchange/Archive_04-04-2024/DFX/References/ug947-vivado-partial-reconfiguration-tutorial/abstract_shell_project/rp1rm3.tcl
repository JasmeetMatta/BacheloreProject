...
if { [string equal -length 5 $scripts_vivado_version $current_vivado_version] == 0} {
   puts ""
   catch {common::send_gid_msg -ssname BD::TCL -id 2041 -severity "ERROR" "This script was generated using Vivado 2022.2 and is being run in <$current_vivado_version> of Vivado. Please run the script in Vivado 2022.2 then open the design in Vivado <$current_vivado_version>. Upgrade the design by running \"Tools => Report => Report IP Status...\", then run write_bd_tcl to create an updated script."}
...
if { $list_projs eq "" } {
   create_project dfx_debug_abs dfx_debug_abs -part xcvc1902-vsva2197-2MP-e-S

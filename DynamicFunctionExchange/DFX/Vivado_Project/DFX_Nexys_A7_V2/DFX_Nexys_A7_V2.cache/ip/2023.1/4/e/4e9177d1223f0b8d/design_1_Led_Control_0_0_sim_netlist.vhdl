...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Led_Control is
  ...
  signal SecondClock_reg : STD_LOGIC_VECTOR ( 16 downto 0 );
  ...
  signal \NLW_SecondClock_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_SecondClock_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
Sclock_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFF0100"
    )
        port map (
...
\SecondClock[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0100FFFF"
    )
        port map (
...
\SecondClock[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => SecondClock_reg(3),
      I1 => SecondClock_reg(12),
      I2 => SecondClock_reg(1),
...
\SecondClock[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => SecondClock_reg(15),
      I2 => SecondClock_reg(14),
      I3 => SecondClock_reg(16),
      I4 => SecondClock_reg(11),
      I5 => SecondClock_reg(6),
      O => \SecondClock[0]_i_6_n_0\
    );
\SecondClock[0]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\SecondClock_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_SecondClock_reg[16]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_SecondClock_reg[16]_i_1_O_UNCONNECTED\(3 downto 1),
      O(0) => \SecondClock_reg[16]_i_1_n_7\,
      S(3 downto 1) => B"000",
      S(0) => SecondClock_reg(16)
    );
